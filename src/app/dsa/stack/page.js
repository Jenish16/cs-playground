...
import {
  ...
  interviewQuestions,
  practicePrompts,
} from "@/lib/dsa/stack-content";

const topic = getDsaTopic("stack");
...
export default function StackTopicPage() {
  return (
    <Container className="flex flex-col gap-10 py-12">
      <PageHeader
        eyebrow="DSA · Stack"
        title={topic.title}
        description="LIFO: push, pop, and peek at a single open end — and where backend systems rely on it."
        actions={
